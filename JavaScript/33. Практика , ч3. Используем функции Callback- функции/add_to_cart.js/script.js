...
let title = this.parentNode.parentNode.parentNode.querySelectorAll(".item_title a");
let price = this.parentNode.parentNode.parentNode.querySelectorAll(".price span");
let image = this.parentNode.parentNode.parentNode.querySelectorAll(".item_image img");
